...
import {Activity, Bot, CircleDollarSign, Home, Users, Workflow, Target, Mail, PlugZap, Clapperboard} from "lucide-react";
...
export default function AppNavigation(){
  ...
  return <>
    <aside className="fixed inset-y-0 left-0 z-20 hidden w-64 border-r border-[var(--prism-border)] bg-[var(--prism-surface)] p-5 lg:block">
      ...
      <div className="mt-8 rounded-2xl border border-[var(--prism-border)] p-4 text-xs text-[var(--prism-muted)]"><CircleDollarSign size={15} className="mb-2"/>Team workspace · Drafts and check-ins save on this device. Use CSV exports to hand off work.</div>
    </aside>
